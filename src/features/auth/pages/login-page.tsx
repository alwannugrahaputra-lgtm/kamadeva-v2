...
export default async function LoginPage({
  ...
  return (
    <section className="container-shell flex min-h-[calc(100vh-120px)] items-center py-14">
      <div className="grid w-full gap-6 rounded-[34px] border border-[rgba(184,139,84,0.14)] bg-[rgba(255,251,246,0.8)] p-3 shadow-[0_28px_60px_rgba(123,96,68,0.1)] lg:grid-cols-[0.85fr_1.15fr]">
        <div className="overflow-hidden rounded-[28px] bg-[linear-gradient(180deg,rgba(55,41,31,0.96),rgba(35,26,20,0.98))] p-7 text-white">
          <p className="text-sm uppercase tracking-[0.2em] text-[rgba(255,241,224,0.72)]">
            Kamadeva Wedding Organizer
          </p>
          <h1 className="mt-5 font-display text-5xl leading-none text-[#fffaf3]">
            Satu sistem, semua terorganisasi.
          </h1>
          <p className="mt-4 max-w-sm text-sm leading-7 text-[rgba(255,243,229,0.74)]">
            Dashboard internal Kamadeva untuk owner, admin, dan staf mengelola
            aktivitas harian dengan alur yang rapi dan cepat dibaca.
          </p>
        ...
        <form
          ...
          className="paper-panel rounded-[28px] p-7 lg:p-8"
        >
          <input type="hidden" name="next" value={next} />
          <p className="text-sm font-semibold text-[var(--brand)]">Selamat Datang Kembali</p>
          <h2 className="section-title mt-3 text-4xl font-semibold text-[var(--brand-deep)]">
            Login untuk mengakses sistem
          </h2>
          <p className="section-copy mt-3 text-sm">
            Gunakan akun internal Kamadeva untuk masuk ke dashboard.
          </p>
          <div className="mt-6 space-y-4">
            <div>
              <label className="mb-2 block text-sm font-medium text-[var(--brand-deep)]">
                Email
              </label>

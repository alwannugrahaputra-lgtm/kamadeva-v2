    ...
    <section className="container-shell public-page-shell">
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        {packages.map((pkg, index) => (
          <ScrollReveal key={pkg.id} variant={index % 2 === 0 ? "up" : "zoom"} delay={0.08 * index}>
            <article className="paper-panel ornament-ring package-motion rounded-[32px] p-6">
              ...
              <div className="mt-5 rounded-[24px] border border-[rgba(212,175,55,0.12)] bg-[rgba(255,255,255,0.4)] p-4 text-sm leading-7 text-[var(--muted)]">
